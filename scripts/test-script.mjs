...
const HEALTHY = {
  "промпты, без единой цифры": [
    ...
    sc2("ПОПРОБУЙ", "Открой бота по ссылке в профиле и собери первую картинку бесплатно."),
  ],
  "цифра в середине, но не крючок": [
    ...
    sc2("ПОПРОБУЙ", "Ссылка на бота в профиле — первые запросы там бесплатные."),
  ],
  ...
  "«непростая задача», но с выводом": [
    ...
    sc2("ПОПРОБУЙ", "Проверь на своей задаче: бот в профиле, попробовать можно бесплатно."),
  ],

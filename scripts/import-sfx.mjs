...
//
// Чем это отличается от build-sfx.mjs: тот СИНТЕЗИРУЕТ звуки с нуля, и потому
// его файлы лежат в репозитории — лицензировать в них нечего. Здесь звуки
// записанные, чужие, и в git они не попадают (assets/sfx и импортированные
// wav в .gitignore). Права на них — на том, кто их принёс; репозиторий
// публичный, и раздавать чужие файлы из него мы не будем.
//

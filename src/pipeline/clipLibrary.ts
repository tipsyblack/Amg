 ...
 *
 * Ставим их туда же, где по нашему правилу и так появляется маскот: хук —
 * лицо ролика, финал — призыв к действию. В середине его быть не должно, там
 * речь про содержание, а не про персонажа.
 */

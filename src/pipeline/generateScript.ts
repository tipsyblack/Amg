  ...
  scenes: [
    {
      ...
      overlay: { object: "спутник с раскрытыми солнечными панелями", word: "космосе", acrossCut: false },
    },
    {
    ...
    },
    {
      ...
      overlay: { object: "капля воды", word: "воды", acrossCut: true },
    },
    {
    ...
    },
    {
      ...
      swap: {
        scene:
          "водонапорная башня в пустом поле, к ней тянется очередь цистерн, на башне ценник",
        word: "вода",
      },
    },
    {
      ...
      overlay: { object: "ракета", word: "орбиту", acrossCut: false },
    },
    {
      ...
      swap: {
        scene:
          "термометр в открытом космосе на фоне звёзд, столбик у самого дна шкалы, вокруг лёд",
        word: "минус",
      },
    },
    {
      ...
      overlay: { object: "красный термометр", word: "перегреются", acrossCut: false },
    },
    {
      caption: "РАДИАТОР В ПОЛСПУТНИКА",
      voiceoverText:
        "Поэтому радиатор будет размером с полспутника.",
      overlay: { object: "спутниковый радиатор с рёбрами", word: "радиатор", acrossCut: false },
    },
    {
      ...
      swap: {
        scene:
          "тот же радиатор, но остывший и тёмный, от рёбер в пустоту уходят волны тепла",
        word: "излучением",
      },
    },
    {
      ...
      overlay: { object: "солнце", word: "Солнце", acrossCut: false },
    },
    {
      ...
      swap: {
        scene:
          "серверный зал на орбите, стойки работают ровно, индикаторы зелёные, за окном Земля",
        word: "отбавляй",
      },
    },
    {

 ...
 *
 * Они в репозитории, так что обычно находятся все. Список всё равно считаем и
 * кладём в video-data.json: файл могут удалить или переименовать, а ссылка на
 * несуществующий звук роняет рендер на последнем кадре. Чего нет — Remotion
 * заменит синтезированным (resolveSfx), и ролик соберётся.
 *

 ...
 * принёс, а репозиторий публичный. На машине, где их не импортировали, стык
 * должен звучать, а не падать с ошибкой — поэтому у каждого вуша есть
 * синтезированная замена, подобранная по весу: воздушному — щелчок, тяжёлому
 * с низом — удар.
 */

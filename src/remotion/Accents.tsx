...
//
// Про размещение: карточка занимает 82% ширины и полосу 9-70% по высоте, под
// ней подпись до ~82%, а ниже идут субтитры по словам. Свободна поэтому только
// полоска над карточкой — все акценты живут там. Первая версия стояла у
// верхнего угла карточки и почти целиком оказалась под ней: акценты рисуются
// ДО карточки, а та непрозрачная.
...
interface AccentsProps {
  sceneIndex: number;
  // Акцент гаснет вместе с уходом сцены, как и подпись.
  exitProgress: number;
}

...
export const videoDataSchema = z.object({
  ...
  // Записанные вуши в репозиторий не кладутся (права на них у того, кто их
  // принёс, а репозиторий публичный), поэтому на чужой машине их может не
  // быть. Список заполняется пайплайном; чего в нём нет — заменяется
  // синтезированным звуком, см. resolveSfx в transitions.ts. Пусто или
  // отсутствует — значит играет только синтез, и ролик всё равно собирается.
